...
class AgentRule(Agent):
    ...
    def next(self, state, turn, greedy_strategy, **kwargs):
        ...
        # a = [0.889, 0.889, 0.887, 0.884, 0.876, 0.865, 0.853, 0.835, 0.803, 0.759, 0.701]
        # b = [0.621, 0.619, 0.609, 0.604, 0.575, 0.549, 0.520, 0.481, 0.406, 0.296, 0.158]
        # a2 = [0.892, 0.891, 0.889, 0.887, 0.880, 0.871, 0.857, 0.838, 0.805, 0.760, 0.701]
        # b2 = [0.601, 0.598, 0.599, 0.596, 0.572, 0.547, 0.517, 0.477, 0.406, 0.296, 0.158]
        # c = []
        # for i,j in zip(a2,b2):
        #     c.append(round((2*i-0.7*j)/2, 3))
        # print(c)
        # assert 0
