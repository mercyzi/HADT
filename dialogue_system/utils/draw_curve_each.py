...
class Ploter(object):
    ...
    def plot(self, save_name, label_list):
        ...
        performance1 = pickle.load(file=open('/home/zxh/HRL_3/src/model/DQN/performance_new/0522004938_agenthrljoint2_1599.p', "rb"))
        sr1 = [item['average_turn'] for key,item in performance1.items()]
        epoch_index = [i for i in range(0, len(sr1))]
        plt.plot(epoch_index,sr1, linewidth=1)
        ...
        for label in self.average_turn.keys():
            ...
            print(y_var)
            # assert 0
            plt.plot(epoch_index,self.average_turn[label], linewidth=1)
    ...
    def plot_mid(self, save_name, label_list):
        ...
        for label in label_list:
            ...
            #绘制柱状图    
            plt.bar(X, Y, bar_width, align="center", color="red", label="Human", alpha=0.5)
...
if __name__ == "__main__":
    ...
    path = "/home/zxh/HRL_3/src/model/DQN/performance_new/"
    save_path = "/home/zxh/HRL_3/src/model/DQN/performance_new/"
    no_key_word_list = ["_99.", "_199.", "_299.", "_399."]
    performance_file_list = Ploter.get_dirlist(path=path,key_word_list=["522004938_age"],no_key_word_list=["_process","group"])
