...
# parser.add_argument("--saved_model", dest="saved_model", type=str, default="/home/zxh/HRL_sy3/src/model/DQN/checkpoint/0428011003_agenthrljoint2_DA0.7_RFH-2_ST3_T20_ss100_lr0.0005_wfrs5.0_RFS30_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-44_mls0_gamma1_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_dtft0_ird0_ubc0.985_lbc1e-10_dataSynthetic_Dataset_RID0/s0.828_r24.835_t12.038_aah0.945_mr2-0.895_e-3703.pkl")
...
# reward design
parser.add_argument("--reward_for_activate_doctor", dest="reward_for_activate_doctor", type=float,default=-2)# 0.45-0.50
parser.add_argument("--reward_for_not_come_yet", dest="reward_for_not_come_yet", type=float,default=0.0)
parser.add_argument("--reward_for_success", dest="reward_for_success", type=float,default=30)
